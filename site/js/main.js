...
;(function(){
  ...
  function loadDvLead(){ if (window.__dvLeadV2 || document.getElementById('dvlead-js')) return; var s=document.createElement('script'); s.id='dvlead-js'; s.src='/js/dv-lead.js?v=1785300000'; document.head.appendChild(s); }
  ...
  function loadBlogCta(){
    ...
    var s=document.createElement('script'); s.id='dvblogcta-js'; s.src='/js/blog-cta.js?v=1785300000'; document.head.appendChild(s);
  }
