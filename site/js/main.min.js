document.addEventListener("DOMContentLoaded",function(){if(document.querySelectorAll(".reveal, section > .container > .section-head, section > .container > .panel, section .hero-grid > *, .svc-card, .wwd-card, .why-card, .tcard, .card, .rev-card").forEach(function(e){e.classList.add("reveal")}),"IntersectionObserver"in window){var e=new IntersectionObserver(function(t){t.forEach(function(t){t.isIntersecting&&(t.target.classList.add("in"),e.unobserve(t.target))})},{threshold:.12});document.querySelectorAll(".reveal").forEach(function(t){e.observe(t)})}else document.querySelectorAll(".reveal").forEach(function(e){e.classList.add("in")});var t=document.querySelectorAll("[data-count]"),n=function(e){var t=parseInt(e.getAttribute("data-count"),10),n=performance.now(),a=function(r){var o,i=Math.min(1,(r-n)/1400),c=Math.floor(t*(1-Math.pow(1-i,3)));e.textContent=t>=1e4?(o=c)>=1e5?(o/1e3).toFixed(0)+"K":String(o):c,i<1&&requestAnimationFrame(a)};requestAnimationFrame(a)};if("IntersectionObserver"in window){var a=new IntersectionObserver(function(e){e.forEach(function(e){e.isIntersecting&&(n(e.target),a.unobserve(e.target))})},{threshold:.4});t.forEach(function(e){a.observe(e)})}var r={seo:{num:"01",title:"SEO &amp; Organic Growth",desc:"Rank, engage and grow sustainably with technical SEO, content strategy and authority links that compound over time.",tags:["Technical SEO","Content Strategy","Link Building","Local SEO"],cta:"Explore SEO Services",href:"seo.html",icon:'<svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>'},paid:{num:"02",title:"Paid Advertising",desc:"From Meta to Google, we turn ad spend into profit with creative that stops the scroll and funnels that convert.",tags:["Meta Ads","Google Ads","LinkedIn","Pinterest","Snapchat"],cta:"Explore Paid Ads",href:"paid-social-media-advertising.html",icon:'<svg viewBox="0 0 24 24"><path d="M3 6h14l4 4v6a2 2 0 0 1-2 2H3z"/><circle cx="8" cy="16" r="2"/><circle cx="17" cy="16" r="2"/></svg>'},perf:{num:"03",title:"Performance Marketing",desc:"Smart funnels, smarter conversions across search, display, shopping and video — fully attributed and reported.",tags:["Search","Shopping","Display","Video","PMax"],cta:"Explore Performance",href:"performance-marketing-agency.html",icon:'<svg viewBox="0 0 24 24"><path d="M3 20h18"/><rect x="5" y="12" width="3" height="7" rx="1"/><rect x="11" y="8" width="3" height="11" rx="1"/><rect x="17" y="4" width="3" height="15" rx="1"/></svg>'},ecom:{num:"04",title:"E-Commerce Management",desc:"End-to-end Amazon, Flipkart and D2C growth — from listing optimization and ads to retention and loyalty.",tags:["Amazon","Flipkart","Shopify","D2C","CRO"],cta:"Explore E-Commerce",href:"ecommerce-marketing.html",icon:'<svg viewBox="0 0 24 24"><path d="M3 7h15l-1.5 9A2 2 0 0 1 14.5 18h-8A2 2 0 0 1 4.5 16.3L3 7z"/><path d="M8 7V5a3 3 0 0 1 6 0v2"/></svg>'},wa:{num:"05",title:"WhatsApp &amp; Native Ads",desc:"Conversational commerce and premium native placements that drive direct response and high engagement.",tags:["WhatsApp API","Swiggy","Zomato","Blinkit","Zepto"],cta:"Explore WhatsApp",href:"whatsapp-marketing-services.html",icon:'<svg viewBox="0 0 24 24"><path d="M4 11a8 8 0 1 1 3.5 6.6L3 19l1.4-4.2A7.9 7.9 0 0 1 4 11z"/></svg>'},brand:{num:"06",title:"Branding &amp; Design",desc:"Research-led branding, identity systems and creative direction that converts at every touchpoint.",tags:["Strategy","Identity","Content","Creative","Web"],cta:"Explore Branding",href:"branding-and-design.html",icon:'<svg viewBox="0 0 24 24"><path d="M9 3l3 5 5 1-4 4 1 6-5-3-5 3 1-6-4-4 5-1z"/></svg>'}},o=document.getElementById("wwdList"),i=document.getElementById("wwdPreview");if(o&&i){var c=o.querySelectorAll(".wwd-row"),s=function(e){var t,n;c.forEach(function(e){e.classList.remove("active")}),e.classList.add("active"),t=e.getAttribute("data-svc"),(n=r[t])&&(i.innerHTML='<div class="pv-icon">'+n.icon+'</div><div><div class="pv-eyebrow">Service '+n.num+"</div><h3>"+n.title+"</h3><p>"+n.desc+'</p><div class="pv-tags">'+n.tags.map(function(e){return"<span>"+e+"</span>"}).join("")+'</div></div><a class="pv-cta" href="'+n.href+'">'+n.cta+"</a>",i.classList.remove("wwd-fade"),i.offsetWidth,i.classList.add("wwd-fade"))};c.forEach(function(e){e.addEventListener("mouseenter",function(){s(e)}),e.addEventListener("click",function(){var t=r[e.getAttribute("data-svc")];t&&(window.location.href=t.href)})})}var l=document.querySelector(".theme-toggle");l&&l.addEventListener("click",function(){var e="dark"===("dark"===document.documentElement.getAttribute("data-theme")?"dark":"light")?"light":"dark";"dark"===e?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{localStorage.setItem("dv-theme",e)}catch(e){}});var d=document.querySelector(".to-top");if(d){var u=function(){d.classList.toggle("show",window.scrollY>400)};u(),window.addEventListener("scroll",u,{passive:!0}),d.addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})})}var h=document.querySelector(".site-header");if(h){var m=function(){h.classList.toggle("scrolled",window.scrollY>20)};m(),window.addEventListener("scroll",m,{passive:!0})}var v=document.querySelector(".hamb"),f=document.querySelector(".nav ul");if(v&&f){v.querySelector("span")||v.appendChild(document.createElement("span")),v.setAttribute("aria-expanded","false"),v.setAttribute("aria-controls","primary-nav-list"),f.id||(f.id="primary-nav-list");var p=function(e){f.classList.toggle("open",e),v.classList.toggle("is-open",e),v.setAttribute("aria-expanded",e?"true":"false"),v.setAttribute("aria-label",e?"Close menu":"Menu"),document.body.classList.toggle("nav-open",e)};v.addEventListener("click",function(e){e.stopPropagation(),p(!f.classList.contains("open"))}),f.querySelectorAll("a.navlink").forEach(function(e){e.addEventListener("click",function(){e.closest(".has-dd")&&window.matchMedia("(max-width: 960px)").matches||p(!1)})}),f.querySelectorAll(".dd-menu a").forEach(function(e){e.addEventListener("click",function(){p(!1)})}),document.addEventListener("click",function(e){f.classList.contains("open")&&(e.target.closest(".nav ul")||e.target.closest(".hamb")||p(!1))}),document.addEventListener("keydown",function(e){"Escape"===e.key&&f.classList.contains("open")&&p(!1)}),window.addEventListener("resize",function(){!window.matchMedia("(max-width: 1050px)").matches&&f.classList.contains("open")&&p(!1)})}document.querySelectorAll(".has-dd").forEach(function(e){var t=e.querySelector(":scope > .navlink"),n=null,a=function(){return window.matchMedia("(max-width: 960px)").matches};t&&t.addEventListener("click",function(n){if(a()&&!e.classList.contains("open")){n.preventDefault();var r=document.querySelector(".nav ul"),o=r?r.scrollTop:0;document.querySelectorAll(".has-dd.open").forEach(function(t){t!==e&&t.classList.remove("open")}),e.classList.add("open"),t.blur&&t.blur(),r&&requestAnimationFrame(function(){r.scrollTop=o})}}),e.addEventListener("mouseenter",function(){a()||(n&&(clearTimeout(n),n=null),e.classList.add("open"))}),e.addEventListener("mouseleave",function(){a()||(n&&clearTimeout(n),n=setTimeout(function(){e.classList.remove("open"),n=null},260))})}),document.addEventListener("click",function(e){e.target.closest(".has-dd")||document.querySelectorAll(".has-dd.open").forEach(function(e){e.classList.remove("open")})}),document.querySelectorAll("[data-carousel]").forEach(function(e){var t=e.parentElement.querySelector("[data-dots]");if(t){var n=function(){var n=e.children;if(n.length){var a=n[0].getBoundingClientRect().width+22,r=Math.max(1,Math.round(e.clientWidth/a)),o=Math.max(1,n.length-r+1);t.innerHTML="";for(var i=0;i<o;i++)t.appendChild(document.createElement("i"));var c=Math.round(e.scrollLeft/a);c=Math.max(0,Math.min(o-1,c)),t.children[c]&&t.children[c].classList.add("on")}};n(),e.addEventListener("scroll",function(){var n=e.children;if(n.length){var a=n[0].getBoundingClientRect().width+22,r=Math.round(e.scrollLeft/a);[].forEach.call(t.children,function(e,t){e.classList.toggle("on",t===r)})}},{passive:!0}),window.addEventListener("resize",n)}}),document.querySelectorAll(".faq-item").forEach(function(e){var t=e.querySelector(".faq-q");t&&t.addEventListener("click",function(){e.classList.toggle("open")})});var g=document.getElementById("contact-form");if(g&&!document.getElementById("btn-send-otp")){var w="info@digiveritaz.com",y=function(){var e=new FormData(g),t=[];e.forEach(function(e,n){if("_"!==n.charAt(0)&&"_honey"!==n&&e)if("services[]"!==n){var a=n.charAt(0).toUpperCase()+n.slice(1);t.push(a+": "+e)}else t.push("Service: "+e)});var n=encodeURIComponent("New lead from DigiVeritaz website"),a=encodeURIComponent(t.join("\n"));window.location.href="mailto:"+w+"?subject="+n+"&body="+a};g.addEventListener("submit",function(e){e.preventDefault();var t=(g.fullname&&g.fullname.value||"").trim(),n=(g.email&&g.email.value||"").trim(),a=(g.phone&&g.phone.value||"").trim(),r=!0;if(g.querySelectorAll(".error_frm").forEach(function(e){e.textContent=""}),!t){var o=g.querySelector("#error_fname");o&&(o.textContent="Please enter your name"),r=!1}if(!n||!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(n)){var i=g.querySelector("#error_email");i&&(i.textContent="Please enter a valid email"),r=!1}if(!a||a.replace(/\D/g,"").length<10){var c=g.querySelector("#error_phone");c&&(c.textContent="Please enter a valid phone number"),r=!1}if(r){var s=g.querySelector("button[type=submit]"),l=s?s.innerHTML:"";s&&(s.disabled=!0,s.innerHTML="Sending…");var d=new FormData(g);d.append("_page",location.pathname||"/contact-us.html"),d.append("_source","website-contact-form"),fetch("https://script.google.com/macros/s/AKfycbz5_zT_5sycLdaSgIbEsNy2W8kNPxozOlcjBnNvu4SOhECw4lzIpCgjsmVIiHo5G0Lw/exec",{method:"POST",body:d,mode:"no-cors",redirect:"follow"}).then(function(){window.location.href="thank-you.html"}).catch(function(){fetch("https://formsubmit.co/ajax/"+w,{method:"POST",headers:{Accept:"application/json"},body:d}).then(function(e){return e.json().then(function(t){return{ok:e.ok,body:t}})}).then(function(e){!e.ok||"true"!==e.body.success&&!0!==e.body.success?(s&&(s.disabled=!1,s.innerHTML=l),y()):window.location.href="thank-you.html"}).catch(function(){s&&(s.disabled=!1,s.innerHTML=l),y()})})}})}!function(){var e=document.querySelector(".client-filter"),t=document.querySelectorAll(".client-marquee"),n=document.querySelector("[data-client-source]");if(e&&!(t.length<2)&&n){var a=Array.prototype.slice.call(n.children);e.addEventListener("click",function(n){var a,r=n.target.closest(".pill");r&&!r.classList.contains("is-active")&&(e.querySelectorAll(".pill").forEach(function(e){e.classList.remove("is-active"),e.setAttribute("aria-selected","false")}),r.classList.add("is-active"),r.setAttribute("aria-selected","true"),a=r.getAttribute("data-filter"),t.forEach(function(e){e.classList.add("is-swapping")}),setTimeout(function(){o(a),requestAnimationFrame(function(){t.forEach(function(e){e.classList.remove("is-swapping")})})},200))}),o("all")}function r(e,t){if(0===t.length)return e.innerHTML="",void(e.style.animationDuration="");for(var n=Math.max(1,Math.ceil(12/t.length)),a=[],r=0;r<n;r++)for(var o=0;o<t.length;o++)a.push(t[o]);var i=a.concat(a);e.innerHTML="",i.forEach(function(t){e.appendChild(t.cloneNode(!0))});var c=268*a.length/55;e.style.animationDuration=c.toFixed(1)+"s"}function o(e){var n=a.filter(function(t){return"all"===e||t.getAttribute("data-category")===e}),o=[],i=[];n.forEach(function(e,t){(t%2==0?o:i).push(e)}),0===i.length&&(i=o.slice().reverse()),r(t[0].querySelector("[data-marquee-track]"),o),r(t[1].querySelector("[data-marquee-track]"),i)}}()});
