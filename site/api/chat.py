...
WHATSAPP     = os.environ.get("WHATSAPP_NUMBER", "918850934184")
...
SERVICES_MENU = [
    ("SEO", "/services/seo/", [r"\bseo\b", r"search engine optim"]),
    ("PPC / Google Ads", "/services/pay-per-click/", [r"\bppc\b", r"pay[- ]per[- ]click", r"google ads", r"search ads"]),
    ("Performance Marketing", "/services/performance-marketing-agency/", [r"performance marketing"]),
    ("Social Media Management", "/services/social-media-management/", [r"social media management", r"social media marketing"]),
    ("Paid Social Ads", "/services/paid-social-media-advertising/", [r"paid social", r"meta ads", r"facebook ads", r"instagram ads", r"social media advertising"]),
    ("E-Commerce Marketing", "/services/ecommerce-marketing/", [r"e-?commerce marketing", r"ecommerce marketing", r"online store marketing"]),
    ("Amazon Marketing", "/services/amazon-marketing/", [r"amazon"]),
    ("Native Advertising", "/services/native-advertising/", [r"native ad"]),
    ("WhatsApp Marketing", "/services/whatsapp-marketing/", [r"whatsapp"]),
    ("Influencer Marketing", "/services/influencer-marketing/", [r"influencer"]),
    ("Digital PR", "/services/digital-pr/", [r"digital pr"]),
    ("Online Reputation", "/services/online-reputation-management/", [r"reputation", r"\borm\b"]),
    ("Content Marketing", "/services/organic-marketing/", [r"content marketing", r"organic marketing", r"content writing", r"copywriting"]),
    ("Branding & Design", "/services/branding-and-design/", [r"branding", r"brand identity", r"\blogo\b"]),
    ("UI/UX Design", "/services/ui-ux-design/", [r"ui/?ux", r"ux design", r"ui design"]),
    ("Website Development", "/services/website-development/", [r"website development", r"web development", r"web design"]),
    ("Custom Software", "/services/custom-software-development/", [r"custom software", r"software development"]),
    ("E-Commerce Development", "/services/ecommerce-development/", [r"e-?commerce development", r"shopify", r"woocommerce", r"online store"]),
    ("Mobile App Development", "/services/mobile-app-development/", [r"mobile app", r"app development"]),
    ("Lead Generation", "/services/lead-generation/", [r"lead generation", r"lead gen"]),
    ("Generative Engine Optimisation", "/services/generative-search-optimisation/", [r"generative engine", r"\bgeo\b", r"\bgso\b"]),
    ("Conversion Rate Optimisation", "/services/conversion-rate-optimisation/", [r"conversion rate", r"\bcro\b", r"landing page"]),
    ("Data Strategy", "/services/data-strategy-consulting-services/", [r"data strategy", r"\bga4\b"]),
]
